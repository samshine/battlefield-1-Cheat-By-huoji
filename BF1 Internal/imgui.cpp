...
ImGuiIO::ImGuiIO()
{
    ...
    IniSavingRate = 5.0f;
    IniFilename = "..\\AA3Cheat\\imgui.ini";
...
/*static*/ void LoadSettings()
{
    ...
    for (const char* line_start = file_data; line_start < buf_end; )
    {
        ...
        else if (settings)
        {
			...
			else if (sscanf(line_start, "ESP=%d\n", &j) == 1)
				Features::ESP = j;
			else if (sscanf(line_start, "Aimbot=%d\n", &j) == 1)
				Features::Aimbot = j;
			else if (sscanf(line_start, "ShowMenu=%d\n", &j) == 1)
				Features::ShowMenu = j;
			else if (sscanf(line_start, "ESPShowFriends=%d\n", &j) == 1)
				Features::ESPShowFriends = j;
			else if (sscanf(line_start, "ShowBones=%d\n", &j) == 1)
				Features::ShowBones = j;
			else if (sscanf(line_start, "ShowVehicles=%d\n", &j) == 1)
				Features::ShowVehicles = j;
			else if (sscanf(line_start, "NoSway=%d\n", &j) == 1)
				Features::NoSway = j;
			else if (sscanf(line_start, "NoSwayRandomize=%d\n", &j) == 1)
				Features::NoSwayRandomize = j;
			else if (sscanf(line_start, "InstantHit=%d\n", &j) == 1)
				Features::InstantHit = j;
			else if (sscanf(line_start, "Crosshair=%d\n", &j) == 1)
				Features::Crosshair = j;
			else if (sscanf(line_start, "Radar=%d\n", &j) == 1)
				Features::Radar = j;
			else if (sscanf(line_start, "RadarSize=%d\n", &j) == 1)
				Features::RadarSize = j;
			else if (sscanf(line_start, "RadarPosX=%d\n", &j) == 1)
				Features::RadarPosX = j;
			else if (sscanf(line_start, "RadarPosY=%d\n", &j) == 1)
				Features::RadarPosY = j;
			else if (sscanf(line_start, "SpectWarn=%d\n", &j) == 1)
				Features::SpectWarn = j;
			else if (sscanf(line_start, "ShowFOV=%d\n", &j) == 1)
				Features::ShowFOV = j;
			else if (sscanf(line_start, "ShowHealth=%d\n", &j) == 1)
				Features::ShowHealth = j;
			else if (sscanf(line_start, "ShowName=%d\n", &j) == 1)
				Features::ShowName = j;
			else if (sscanf(line_start, "ShowDistance=%d\n", &j) == 1)
				Features::ShowDistance = j;
			else if (sscanf(line_start, "ShowESPBoxes=%d\n", &j) == 1)
				Features::ShowESPBoxes = j;
			else if (sscanf(line_start, "ESPDistance=%f\n", &i) == 1)
				Features::ESPDistance = i;
			else if (sscanf(line_start, "MedicBugfix=%d\n", &j) == 1)
				Features::MedicBugfix = j;
			else if (sscanf(line_start, "giveAutoCleanSS=%d\n", &j) == 1)
				Features::giveAutoCleanSS = j;
			else if (sscanf(line_start, "AutoCleanSSTimer=%f\n", &i) == 1)
				Features::AutoCleanSSTimer = i;
			else if (sscanf(line_start, "giveCleanSSwithRMB=%d\n", &j) == 1)
				Features::giveCleanSSwithRMB = j;
			else if (sscanf(line_start, "AimSlots2=%d\n", &j) == 1)
				Vars.AimSlots2 = j;
			else if (sscanf(line_start, "AimSlots5=%d\n", &j) == 1)
				Vars.AimSlots5 = j;
			else if (sscanf(line_start, "AimSlots6=%d\n", &j) == 1)
				Vars.AimSlots6 = j;
			else if (sscanf(line_start, "AimSlots7=%d\n", &j) == 1)
				Vars.AimSlots7 = j;
			else if (sscanf(line_start, "aAimKey1=%d\n", &j) == 1)
				Vars.A.Aimkey1 = j;
			else if (sscanf(line_start, "aAimKey2=%d\n", &j) == 1)
				Vars.A.Aimkey2 = j;
			else if (sscanf(line_start, "bAimKey1=%d\n", &j) == 1)
				Vars.B.Aimkey1 = j;
			else if (sscanf(line_start, "bAimKey2=%d\n", &j) == 1)
				Vars.B.Aimkey2 = j;
			else if (sscanf(line_start, "cAimKey1=%d\n", &j) == 1)
				Vars.C.Aimkey1 = j;
			else if (sscanf(line_start, "cAimKey2=%d\n", &j) == 1)
				Vars.C.Aimkey2 = j;
			else if (sscanf(line_start, "dAimKey1=%d\n", &j) == 1)
				Vars.D.Aimkey1 = j;
			else if (sscanf(line_start, "dAimKey2=%d\n", &j) == 1)
				Vars.D.Aimkey2 = j;
			else if (sscanf(line_start, "eAimKey1=%d\n", &j) == 1)
				Vars.E.Aimkey1 = j;
			else if (sscanf(line_start, "eAimKey2=%d\n", &j) == 1)
				Vars.E.Aimkey2 = j;
			else if (sscanf(line_start, "aSmoothFactor=%f\n", &j) == 1)
				Vars.A.SmoothFactor = j;
			else if (sscanf(line_start, "bSmooth=%f\n", &j) == 1)
				Vars.B.SmoothFactor = j;
			else if (sscanf(line_start, "cSmoothFactor=%f\n", &j) == 1)
				Vars.C.SmoothFactor = j;
			else if (sscanf(line_start, "dSmoothFactor=%f\n", &j) == 1)
				Vars.D.SmoothFactor = j;
			else if (sscanf(line_start, "eSmoothFactor=%f\n", &j) == 1)
				Vars.E.SmoothFactor = j;
			else if (sscanf(line_start, "aFOV=%f\n", &j) == 1)
				Vars.A.FOV = j;
			else if (sscanf(line_start, "bFOV=%f\n", &j) == 1)
				Vars.B.FOV = j;
			else if (sscanf(line_start, "cFOV=%f\n", &j) == 1)
				Vars.C.FOV = j;
			else if (sscanf(line_start, "dFOV=%f\n", &j) == 1)
				Vars.D.FOV = j;
			else if (sscanf(line_start, "eFOV=%f\n", &j) == 1)
				Vars.E.FOV = j;
			else if (sscanf(line_start, "aDistance=%f\n", &j) == 1)
				Vars.A.Distance = j;
			else if (sscanf(line_start, "bDistance=%f\n", &j) == 1)
				Vars.B.Distance = j;
			else if (sscanf(line_start, "cDistance=%f\n", &j) == 1)
				Vars.C.Distance = j;
			else if (sscanf(line_start, "dDistance=%f\n", &j) == 1)
				Vars.D.Distance = j;
			else if (sscanf(line_start, "eDistance=%f\n", &j) == 1)
				Vars.E.Distance = j;
			else if (sscanf(line_start, "aBone=%d\n", &j) == 1)
				Vars.A.Bone = j;
			else if (sscanf(line_start, "bBone=%d\n", &j) == 1)
				Vars.B.Bone = j;
			else if (sscanf(line_start, "cBone=%d\n", &j) == 1)
				Vars.C.Bone = j;
			else if (sscanf(line_start, "dBone=%d\n", &j) == 1)
				Vars.D.Bone = j;
			else if (sscanf(line_start, "eBone=%d\n", &j) == 1)
				Vars.E.Bone = j;
			else if (sscanf(line_start, "aRetargetTimer=%f\n", &j) == 1)
				Vars.A.RetargetTimer = j;
			else if (sscanf(line_start, "bRetargetTimer=%f\n", &j) == 1)
				Vars.B.RetargetTimer = j;
			else if (sscanf(line_start, "cRetargetTimer=%f\n", &j) == 1)
				Vars.C.RetargetTimer = j;
			else if (sscanf(line_start, "dRetargetTimer=%f\n", &j) == 1)
				Vars.D.RetargetTimer = j;
			else if (sscanf(line_start, "eRetargetTimer=%f\n", &j) == 1)
				Vars.E.RetargetTimer = j;
			else if (sscanf(line_start, "aRandomBone=%d\n", &j) == 1)
				Vars.A.RandomBone = j;
			else if (sscanf(line_start, "bRandomBone=%d\n", &j) == 1)
				Vars.B.RandomBone = j;
			else if (sscanf(line_start, "cRandomBone=%d\n", &j) == 1)
				Vars.C.RandomBone = j;
			else if (sscanf(line_start, "dRandomBone=%d\n", &j) == 1)
				Vars.D.RandomBone = j;
			else if (sscanf(line_start, "eRandomBone=%d\n", &j) == 1)
				Vars.E.RandomBone = j;
			else if (sscanf(line_start, "aPrioritizeDistance=%d\n", &j) == 1)
				Vars.A.PrioritizeDistance = j;
			else if (sscanf(line_start, "bPrioritizeDistance=%d\n", &j) == 1)
				Vars.B.PrioritizeDistance = j;
			else if (sscanf(line_start, "cPrioritizeDistance=%d\n", &j) == 1)
				Vars.C.PrioritizeDistance = j;
			else if (sscanf(line_start, "dPrioritizeDistance=%d\n", &j) == 1)
				Vars.D.PrioritizeDistance = j;
			else if (sscanf(line_start, "ePrioritizeDistance=%d\n", &j) == 1)
				Vars.E.PrioritizeDistance = j;
			else if (sscanf(line_start, "aAimPrediction=%d\n", &j) == 1)
				Vars.A.AimPrediction = j;
			else if (sscanf(line_start, "bAimPrediction=%d\n", &j) == 1)
				Vars.B.AimPrediction = j;
			else if (sscanf(line_start, "cAimPrediction=%d\n", &j) == 1)
				Vars.C.AimPrediction = j;
			else if (sscanf(line_start, "dAimPrediction=%d\n", &j) == 1)
				Vars.D.AimPrediction = j;
			else if (sscanf(line_start, "eAimPrediction=%d\n", &j) == 1)
				Vars.E.AimPrediction = j;
			else if (sscanf(line_start, "aAimPredictXYZ=%f\n", &j) == 1)
				Vars.A.AimPredictXYZ = j;
			else if (sscanf(line_start, "bAimPredictXYZ=%f\n", &j) == 1)
				Vars.B.AimPredictXYZ = j;
			else if (sscanf(line_start, "cAimPredictXYZ=%f\n", &j) == 1)
				Vars.C.AimPredictXYZ = j;
			else if (sscanf(line_start, "dAimPredictXYZ=%f\n", &j) == 1)
				Vars.D.AimPredictXYZ = j;
			else if (sscanf(line_start, "eAimPredictXYZ=%f\n", &j) == 1)
				Vars.E.AimPredictXYZ = j;
			else if (sscanf(line_start, "aAimOffsetY=%f\n", &j) == 1)
				Vars.A.AimOffsetY = j;
			else if (sscanf(line_start, "bAimOffsetY=%f\n", &j) == 1)
				Vars.B.AimOffsetY = j;
			else if (sscanf(line_start, "cAimOffsetY=%f\n", &j) == 1)
				Vars.C.AimOffsetY = j;
			else if (sscanf(line_start, "dAimOffsetY=%f\n", &j) == 1)
				Vars.D.AimOffsetY = j;
			else if (sscanf(line_start, "eAimOffsetY=%f\n", &j) == 1)
				Vars.E.AimOffsetY = j;
			else if (sscanf(line_start, "aAimVehicles=%d\n", &j) == 1)
				Vars.A.AimVehicles = j;
			else if (sscanf(line_start, "bAimVehicles=%d\n", &j) == 1)
				Vars.B.AimVehicles = j;
			else if (sscanf(line_start, "cAimVehicles=%d\n", &j) == 1)
				Vars.C.AimVehicles = j;
			else if (sscanf(line_start, "dAimVehicles=%d\n", &j) == 1)
				Vars.D.AimVehicles = j;
			else if (sscanf(line_start, "eAimVehicles=%d\n", &j) == 1)
				Vars.E.AimVehicles = j;
			else if (sscanf(line_start, "aAimHorses=%d\n", &j) == 1)
				Vars.A.AimHorses = j;
			else if (sscanf(line_start, "bAimHorses=%d\n", &j) == 1)
				Vars.B.AimHorses = j;
			else if (sscanf(line_start, "cAimHorses=%d\n", &j) == 1)
				Vars.C.AimHorses = j;
			else if (sscanf(line_start, "dAimHorses=%d\n", &j) == 1)
				Vars.D.AimHorses = j;
			else if (sscanf(line_start, "eAimHorses=%d\n", &j) == 1)
				Vars.E.AimHorses = j;
			else if (sscanf(line_start, "aVehicleBone=%d\n", &j) == 1)
				Vars.A.VehicleBone = j;
			else if (sscanf(line_start, "bVehicleBone=%d\n", &j) == 1)
				Vars.B.VehicleBone = j;
			else if (sscanf(line_start, "cVehicleBone=%d\n", &j) == 1)
				Vars.C.VehicleBone = j;
			else if (sscanf(line_start, "dVehicleBone=%d\n", &j) == 1)
				Vars.D.VehicleBone = j;
			else if (sscanf(line_start, "eVehicleBone=%d\n", &j) == 1)
				Vars.E.VehicleBone = j;
			else if (sscanf(line_start, "aHorseBone=%d\n", &j) == 1)
				Vars.A.HorseBone = j;
			else if (sscanf(line_start, "bHorseBone=%d\n", &j) == 1)
				Vars.B.HorseBone = j;
			else if (sscanf(line_start, "cHorseBone=%d\n", &j) == 1)
				Vars.C.HorseBone = j;
			else if (sscanf(line_start, "dHorseBone=%d\n", &j) == 1)
				Vars.D.HorseBone = j;
			else if (sscanf(line_start, "eHorseBone=%d\n", &j) == 1)
				Vars.E.HorseBone = j;
			else if (sscanf(line_start, "aBoneSelected=%d\n", &j) == 1)
				Vars.A.BoneSelected = j;
			else if (sscanf(line_start, "bBoneSelected=%d\n", &j) == 1)
				Vars.B.BoneSelected = j;
			else if (sscanf(line_start, "cBoneSelected=%d\n", &j) == 1)
				Vars.C.BoneSelected = j;
			else if (sscanf(line_start, "dBoneSelected=%d\n", &j) == 1)
				Vars.D.BoneSelected = j;
			else if (sscanf(line_start, "eBoneSelected=%d\n", &j) == 1)
				Vars.E.BoneSelected = j;
				*/
            ...
            if (sscanf(line_start, "Pos=%f,%f", &x, &y) == 2)
				...
				Features::ESPDistance = i;
			else if (sscanf(line_start, "SmoothFactor=%f\n", &i) == 1)
				Aimbot::SmoothFactor = i;
			else if (sscanf(line_start, "FOV=%f\n", &i) == 1)
				Aimbot::FOV = i;
			else if (sscanf(line_start, "Distance=%f\n", &i) == 1)
				Aimbot::Distance = i;
			else if (sscanf(line_start, "Bone=%d\n", &j) == 1)
				Aimbot::Bone = j;
			else if (sscanf(line_start, "RetargetTimer=%d\n", &j) == 1)
				Aimbot::RetargetTimer = j;
			else if (sscanf(line_start, "RandomBone=%d\n", &i) == 1)
				Aimbot::RandomBone = i;
			else if (sscanf(line_start, "PrioritizeDistance=%d\n", &j) == 1)
				Aimbot::PrioritizeDistance = j;
			else if (sscanf(line_start, "AimPrediction=%d\n", &j) == 1)
				Aimbot::AimPrediction = j;
			else if (sscanf(line_start, "AimPredictXYZ=%f\n", &i) == 1)
				Aimbot::AimPredictXYZ = i;
			else if (sscanf(line_start, "AimOffsetY=%f\n", &i) == 1)
				Aimbot::AimOffsetY = i;
			else if (sscanf(line_start, "MedicBugfix=%d\n", &j) == 1)
				Features::MedicBugfix = j;			
			else if (sscanf(line_start, "giveAutoCleanSS=%d\n", &j) == 1)
				...
				Features::giveCleanSSwithRMB = j;
			else if (sscanf(line_start, "AimVehicles=%d\n", &j) == 1)
				Aimbot::AimVehicles = j;
			else if (sscanf(line_start, "AimHorses=%d\n", &j) == 1)
				Aimbot::AimHorses = j;
			else if (sscanf(line_start, "VehicleBone=%d\n", &j) == 1)
				Aimbot::VehicleBone = j;
			else if (sscanf(line_start, "HorseBone=%d\n", &j) == 1)
				Aimbot::HorseBone = j;
			else if (sscanf(line_start, "AimSlots2=%d\n", &j) == 1)
				Aimbot::AimSlots2 = j;
			else if (sscanf(line_start, "AimSlots5=%d\n", &j) == 1)
				...
				Aimbot::AimSlots7 = j;
			else if (sscanf(line_start, "AimKey1=%d\n", &j) == 1)
				Aimbot::Aimkey1 = j;
			else if (sscanf(line_start, "AimKey2=%d\n", &j) == 1)
				Aimbot::Aimkey2 = j;
			/*
			//////KEYS BINDINGS
			else if (sscanf(line_start, "key_StartHack=%d\n", &j) == 1) key_StartHack = j;
			else if (sscanf(line_start, "key_ShowMenu=%d\n", &j) == 1) key_ShowMenu = j;
			else if (sscanf(line_start, "key_Quit=%d\n", &j) == 1) key_Quit = j;
			else if (sscanf(line_start, "key_Save=%d\n", &j) == 1) key_Save = j;
			else if (sscanf(line_start, "key_ShowName=%d\n", &j) == 1) key_ShowName = j;
			else if (sscanf(line_start, "key_Aimbot=%d\n", &j) == 1) key_Aimbot = j;
			else if (sscanf(line_start, "key_Radar=%d\n", &j) == 1) key_Radar = j;
			else if (sscanf(line_start, "key_RadarWide=%d\n", &j) == 1) key_RadarWide = j;
			else if (sscanf(line_start, "key_NoSway=%d\n", &j) == 1) key_NoSway = j;
			else if (sscanf(line_start, "key_giveCleanSS=%d\n", &j) == 1) key_giveCleanSS = j;
			else if (sscanf(line_start, "key_MedicBugfix=%d\n", &j) == 1) key_MedicBugfix = j;
			else if (sscanf(line_start, "key_ESP=%d\n", &j) == 1) key_ESP = j;
			else if (sscanf(line_start, "key_HEAD=%d\n", &j) == 1) key_HEAD = j;
			else if (sscanf(line_start, "key_NECK=%d\n", &j) == 1) key_NECK = j;
			else if (sscanf(line_start, "key_HIP=%d\n", &j) == 1) key_HIP = j;
			else if (sscanf(line_start, "key_TestSSBitBlt=%d\n", &j) == 1) key_TestSSBitBlt = j;
			else if (sscanf(line_start, "key_TestSSCopyResource=%d\n", &j) == 1) key_TestSSCopyResource = j;
			*/
        }
...
static void SaveSettings()
{
	...
	fprintf(f, "ESP=%d\n", Features::ESP);
	fprintf(f, "Aimbot=%d\n", Features::Aimbot);
	fprintf(f, "ShowMenu=%d\n", Features::ShowMenu);
	fprintf(f, "ESPShowFriends=%d\n", Features::ESPShowFriends);
	fprintf(f, "ShowBones=%d\n", Features::ShowBones);
	fprintf(f, "ShowVehicles=%d\n", Features::ShowVehicles);
	fprintf(f, "NoSway=%d\n", Features::NoSway);
	fprintf(f, "NoSwayRandomize=%d\n", Features::NoSwayRandomize);
	fprintf(f, "InstantHit=%d\n", Features::InstantHit);
	fprintf(f, "Crosshair=%d\n", Features::Crosshair);
	fprintf(f, "Radar=%d\n", Features::Radar);
	fprintf(f, "RadarSize=%d\n", Features::RadarSize);
	fprintf(f, "RadarPosX=%d\n", Features::RadarPosX);
	fprintf(f, "RadarPosY=%d\n", Features::RadarPosY);
	fprintf(f, "SpectWarn=%d\n", Features::SpectWarn);
	fprintf(f, "ShowFOV=%d\n", Features::ShowFOV);
	fprintf(f, "ShowHealth=%d\n", Features::ShowHealth);
	fprintf(f, "ShowName=%d\n", Features::ShowName);
	fprintf(f, "ShowDistance=%d\n", Features::ShowDistance);
	fprintf(f, "ShowESPBoxes=%d\n", Features::ShowESPBoxes);
	fprintf(f, "ESPDistance=%f\n", Features::ESPDistance);
	fprintf(f, "MedicBugfix=%d\n", Features::MedicBugfix);
	fprintf(f, "giveAutoCleanSS=%d\n", Features::giveAutoCleanSS);
	fprintf(f, "AutoCleanSSTimer=%f\n", Features::AutoCleanSSTimer);
	fprintf(f, "giveCleanSSwithRMB=%d\n", Features::giveCleanSSwithRMB);

	fprintf(f, "AimSlots2=%d\n", Vars.AimSlots2);
	fprintf(f, "AimSlots5=%d\n", Vars.AimSlots5);
	fprintf(f, "AimSlots6=%d\n", Vars.AimSlots6);
	fprintf(f, "AimSlots7=%d\n", Vars.AimSlots7);

	fprintf(f, "aAimKey1=%d\n", Vars.A.Aimkey1);
	fprintf(f, "aAimKey2=%d\n", Vars.A.Aimkey2);

	fprintf(f, "bimKey1=%d\n", Vars.B.Aimkey1);
	fprintf(f, "bAimKey2=%d\n", Vars.B.Aimkey2);
	fprintf(f, "cAimKey1=%d\n", Vars.C.Aimkey1);
	fprintf(f, "cAimKey2=%d\n", Vars.C.Aimkey2);
	fprintf(f, "dAimKey1=%d\n", Vars.D.Aimkey1);
	fprintf(f, "dAimKey2=%d\n", Vars.D.Aimkey2);
	fprintf(f, "eAimKey1=%d\n", Vars.E.Aimkey1);
	fprintf(f, "eAimKey2=%d\n", Vars.E.Aimkey2);


	fprintf(f, "aSmoothFactor=%f\n", Vars.A.SmoothFactor);
	fprintf(f, "bSmooth=%f\n", Vars.B.SmoothFactor);
	fprintf(f, "cSmoothFactor=%f\n", Vars.C.SmoothFactor);
	fprintf(f, "dSmoothFactor=%f\n", Vars.D.SmoothFactor);
	fprintf(f, "eSmoothFactor=%f\n", Vars.E.SmoothFactor);
	fprintf(f, "aFOV=%f\n", Vars.A.FOV);
	fprintf(f, "bFOV=%f\n", Vars.B.FOV);
	fprintf(f, "cFOV=%f\n", Vars.C.FOV);
	fprintf(f, "dFOV=%f\n", Vars.D.FOV);
	fprintf(f, "eFOV=%f\n", Vars.E.FOV);
	fprintf(f, "aDistance=%f\n", Vars.A.Distance);
	fprintf(f, "bDistance=%f\n", Vars.B.Distance);
	fprintf(f, "cDistance=%f\n", Vars.C.Distance);
	fprintf(f, "dDistance=%f\n", Vars.D.Distance);
	fprintf(f, "eDistance=%f\n", Vars.E.Distance);
	fprintf(f, "aBone=%d\n", (int)Vars.A.Bone);
	fprintf(f, "bBone=%d\n", (int)Vars.B.Bone);
	fprintf(f, "cBone=%d\n", (int)Vars.C.Bone);
	fprintf(f, "dBone=%d\n", (int)Vars.D.Bone);
	fprintf(f, "eBone=%d\n", (int)Vars.E.Bone);
	fprintf(f, "aRetargetTimer=%d\n", Vars.A.RetargetTimer);
	fprintf(f, "bRetargetTimer=%d\n", Vars.B.RetargetTimer);
	fprintf(f, "cRetargetTimer=%d\n", Vars.C.RetargetTimer);
	fprintf(f, "dRetargetTimer=%d\n", Vars.D.RetargetTimer);
	fprintf(f, "eRetargetTimer=%d\n", Vars.E.RetargetTimer);

	fprintf(f, "aRandomBone=%d\n", Vars.A.RandomBone);
	fprintf(f, "bRandomBone=%d\n", Vars.B.RandomBone);
	fprintf(f, "cRandomBone=%d\n", Vars.C.RandomBone);
	fprintf(f, "dRandomBone=%d\n", Vars.D.RandomBone);
	fprintf(f, "eRandomBone=%d\n", Vars.E.RandomBone);
	fprintf(f, "aPrioritizeDistance=%d\n", Vars.A.PrioritizeDistance);
	fprintf(f, "bPrioritizeDistance=%d\n", Vars.B.PrioritizeDistance);
	fprintf(f, "cPrioritizeDistance=%d\n", Vars.C.PrioritizeDistance);
	fprintf(f, "dPrioritizeDistance=%d\n", Vars.D.PrioritizeDistance);
	fprintf(f, "ePrioritizeDistance=%d\n", Vars.E.PrioritizeDistance);
	fprintf(f, "aAimPrediction=%d\n", Vars.A.AimPrediction);
	fprintf(f, "aAimPredictXYZ=%f\n", Vars.A.AimPredictXYZ);
	fprintf(f, "aAimOffsetY=%f\n", Vars.A.AimOffsetY);
	fprintf(f, "aAimVehicles=%d\n", Vars.A.AimVehicles);
	fprintf(f, "aAimHorses=%d\n", Vars.A.AimHorses);
	fprintf(f, "aVehicleBone=%d\n", Vars.A.VehicleBone);
	fprintf(f, "aHorseBone=%d\n", Vars.A.HorseBone);

	fprintf(f, "bAimPrediction=%d\n", Vars.B.AimPrediction);
	fprintf(f, "bAimPredictXYZ=%f\n", Vars.B.AimPredictXYZ);
	fprintf(f, "bAimOffsetY=%f\n", Vars.B.AimOffsetY);
	fprintf(f, "bAimVehicles=%d\n", Vars.B.AimVehicles);
	fprintf(f, "bAimHorses=%d\n", Vars.B.AimHorses);
	fprintf(f, "bVehicleBone=%d\n", Vars.B.VehicleBone);
	fprintf(f, "bHorseBone=%d\n", Vars.B.HorseBone);

	fprintf(f, "cAimPrediction=%d\n", Vars.C.AimPrediction);
	fprintf(f, "cAimPredictXYZ=%f\n", Vars.C.AimPredictXYZ);
	fprintf(f, "cAimOffsetY=%f\n", Vars.C.AimOffsetY);
	fprintf(f, "cAimVehicles=%d\n", Vars.C.AimVehicles);
	fprintf(f, "cAimHorses=%d\n", Vars.C.AimHorses);
	fprintf(f, "cVehicleBone=%d\n", Vars.C.VehicleBone);
	fprintf(f, "cHorseBone=%d\n", Vars.C.HorseBone);

	fprintf(f, "dAimPrediction=%d\n", Vars.D.AimPrediction);
	fprintf(f, "dAimPredictXYZ=%f\n", Vars.D.AimPredictXYZ);
	fprintf(f, "dAimOffsetY=%f\n", Vars.D.AimOffsetY);
	fprintf(f, "dAimVehicles=%d\n", Vars.D.AimVehicles);
	fprintf(f, "dAimHorses=%d\n", Vars.D.AimHorses);
	fprintf(f, "dVehicleBone=%d\n", Vars.D.VehicleBone);
	fprintf(f, "dHorseBone=%d\n", Vars.D.HorseBone);

	fprintf(f, "eAimPrediction=%d\n", Vars.E.AimPrediction);
	fprintf(f, "eAimPredictXYZ=%f\n", Vars.E.AimPredictXYZ);
	fprintf(f, "eAimOffsetY=%f\n", Vars.E.AimOffsetY);
	fprintf(f, "eAimVehicles=%d\n", Vars.E.AimVehicles);
	fprintf(f, "eAimHorses=%d\n", Vars.E.AimHorses);
	fprintf(f, "eVehicleBone=%d\n", Vars.E.VehicleBone);
	fprintf(f, "eHorseBone=%d\n", Vars.E.HorseBone);

	fprintf(f, "aBoneSelected=%d\n", Vars.A.BoneSelected);
	fprintf(f, "bBoneSelected=%f\n", Vars.B.BoneSelected);
	fprintf(f, "cBoneSelected=%f\n", Vars.C.BoneSelected);
	fprintf(f, "dBoneSelected=%d\n", Vars.D.BoneSelected);
	fprintf(f, "eBoneSelected=%d\n", Vars.E.BoneSelected);
	*/
	...
	fprintf(f, "AutoCleanSSTimer=%f\n", Features::AutoCleanSSTimer);
	fprintf(f, "giveCleanSSwithRMB=%d\n", Features::giveCleanSSwithRMB);	
	fprintf(f, "SmoothFactor=%f\n", Aimbot::SmoothFactor);
	fprintf(f, "FOV=%f\n", Aimbot::FOV);
	fprintf(f, "Distance=%f\n", Aimbot::Distance);
	fprintf(f, "Bone=%d\n", (int)Aimbot::Bone);
	fprintf(f, "RetargetTimer=%d\n", Aimbot::RetargetTimer);
	fprintf(f, "RandomBone=%d\n", Aimbot::RandomBone);
	fprintf(f, "PrioritizeDistance=%d\n", Aimbot::PrioritizeDistance);
	fprintf(f, "AimPrediction=%d\n", Aimbot::AimPrediction);
	fprintf(f, "AimPredictXYZ=%f\n", Aimbot::AimPredictXYZ);
	fprintf(f, "AimOffsetY=%f\n", Aimbot::AimOffsetY);
	fprintf(f, "AimVehicles=%d\n", Aimbot::AimVehicles);
	fprintf(f, "AimHorses=%d\n", Aimbot::AimHorses);
	fprintf(f, "VehicleBone=%d\n", Aimbot::VehicleBone);
	fprintf(f, "HorseBone=%d\n", Aimbot::HorseBone);	
	fprintf(f, "AimSlots2=%d\n", Aimbot::AimSlots2);
	fprintf(f, "AimSlots5=%d\n", Aimbot::AimSlots5);
	fprintf(f, "AimSlots6=%d\n", Aimbot::AimSlots6);
	fprintf(f, "AimSlots7=%d\n", Aimbot::AimSlots7);
	...
	/*
	fprintf(f, "\n");
	fprintf(f, "---KEYS BINDINGS---\n");
	fprintf(f, "key_StartHack=%d\n", key_StartHack);
	fprintf(f, "key_ShowMenu=%d\n", key_ShowMenu);
	fprintf(f, "key_Quit=%d\n", key_Quit);
	fprintf(f, "key_Save=%d\n", key_Save);
	fprintf(f, "key_ShowName=%d\n", key_ShowName);
	fprintf(f, "key_Aimbot=%d\n", key_Aimbot);
	fprintf(f, "key_Radar=%d\n", key_Radar);
	fprintf(f, "key_RadarWide=%d\n", key_RadarWide);
	fprintf(f, "key_NoSway=%d\n", key_NoSway);
	fprintf(f, "key_giveCleanSS=%d\n", key_giveCleanSS);
	fprintf(f, "key_MedicBugfix=%d\n", key_MedicBugfix);
	fprintf(f, "key_ESP=%d\n", key_ESP);
	fprintf(f, "key_HEAD=%d\n", key_HEAD);
	fprintf(f, "key_NECK=%d\n", key_NECK);
	fprintf(f, "key_HIP=%d\n", key_HIP);
	fprintf(f, "key_TestSSBitBlt=%d\n", key_TestSSBitBlt);
	fprintf(f, "key_TestSSCopyResource=%d\n", key_TestSSCopyResource);
	*/
    fclose(f);
}

/*static*/ void MarkSettingsDirty()  //exposed for outside call
{
    ImGuiContext& g = *GImGui;
    if (g.SettingsDirtyTimer <= 0.0f)
...
bool ImGui::InputTextEx(const char* label, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiTextEditCallback callback, void* user_data)
{
    ...
    if (g.ActiveId == id)
    {
        ...
        else if (is_shortcutkey_only && IsKeyPressed(KEY_Z) && is_editable)    { edit_state.OnKeyPressed(STB_TEXTEDIT_K_UNDO); edit_state.ClearSelection(); }
        else if (is_shortcutkey_only && IsKeyPressed(KEY_Y) && is_editable)    { edit_state.OnKeyPressed(STB_TEXTEDIT_K_REDO); edit_state.ClearSelection(); }
        else if (is_shortcutkey_only && IsKeyPressed(KEY_A))                   { edit_state.SelectAll(); edit_state.CursorFollow = true; }
        else if (is_shortcutkey_only && !is_password && ((IsKeyPressed(KEY_X) && is_editable) || IsKeyPressed(KEY_C)) && (!is_multiline || edit_state.HasSelection()))
        {
			// Cut, Copy
            const bool cut = IsKeyPressed(KEY_X);
        ...
        else if (is_shortcutkey_only && IsKeyPressed(KEY_V) && is_editable)
        {
            // Paste
...
ushort ImGui::InputScalarEx(const char* label, ImGuiDataType data_type, void* data_ptr, void* step_ptr, void* step_fast_ptr, const char* scalar_format, ImGuiInputTextFlags extra_flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
...
ushort ImGui::InputFloat(const char* label, float* v, float step, float step_fast, int decimal_precision, ImGuiInputTextFlags extra_flags)
{
...
bool ImGui::InputInt(const char* label, int* v, int step, int step_fast, ImGuiInputTextFlags extra_flags)
{
    ...
    return (InputScalarEx(label, ImGuiDataType_Int, (void*)v, (void*)(step>0.0f ? &step : NULL), (void*)(step_fast>0.0f ? &step_fast : NULL), scalar_format, extra_flags) > 0) ? true : false;
}
